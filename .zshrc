...
export PATH=$JAVA_HOME/bin:~/.npm-global/bin:$HOME/bin:$HOME/.config/bspwm/set_tiling_desktop.sh:$HOME/go/bin:$HOME/.cargo/bin:$HOME/.local/share/gem/ruby/3.0.0/bin:$HOME/.local/bin:$HOME/Development/OpenMS-build/bin:/usr/local/bin:$HOME/.emacs.d/bin:$PATH
...
plugins=(git docker docker-compose dnf npm command-not-found
  # extra plugins - note that these need to be installed manually
  auto-notify zsh-autosuggestions zsh-completions)
