...
"       \ 'name' : '+code' ,
"       \ 'r' : [':vsp term://R"<CR><C-\><C-N><C-w>h"'         , 'Start R console'],
"       \ 'p' : [':vsp term://ipython3"<CR><C-\><C-N><C-w>h"'         , 'Start R console'],
"       \ 'e' : ['"<C-\><C-N>"'         , 'Exit terminal'],
"       \ 's' : {
"         \ 'name': '+SQL lite',
"         \ 'o' : [':new term://isqlite3<CR><C-\><C-n><C-w>k' , 'Start sqlite console'],
"         \ },
"       \ }

      " for nvimr and vimcmdline
let g:which_key_map.c = {
      \ 'name' : '+code' ,
      \ 'o' : [':call VimCmdLineStartApp()"<CR>"' , 'Open interpreter'],
      \ 's' : [':call VimCmdLineSendSelection()"<CR>"' , 'Send selection'],
      \ 'l' : [':call VimCmdLineSendLine()"<CR>"' , 'Send line'],
      \ 'b' : [':call VimCmdLineSendMBlock()"<CR>"' , 'Send block'],
      \ 'p' : [':call VimCmdLineSendParagraph()"<CR>"' , 'Send paragraph'],
      \ 'q' : [':call VimCmdLineQuit()"<CR>"' , 'Quit interpreter'],
      \ 'r' : {
        \ 'name': '+R',
        \ 'o' : [':call StartR("R")'        , 'Start R console'],
        \ 'b' : [':call RObjBrowser()'        , 'Open Object browser'],
        \ 'h' : [':call RAction("help")'        , 'Help Doc'],
        \ 's' : [':call SendSelectionToR("echo", "stay", "normal") '    , 'Run selection'],
        \ 'l' : [':call SendLineToR("down") '    , 'Run line'],
        \ 'q' : [':call RQuit("nosave")'    , 'Quit - nosave'],
        \ 'Q' : [':call RQuit("save")'    , 'Quit - save'],
        \ },
      \ }
