...
#+begin_src emacs-lisp
  ...
  ;; (add-hook 'sql-interactive-mode-hook 'lsp-mode)
  ;; (add-hook 'sql-mode-hook 'lsp-mode)
  (add-hook 'sql-mode-hook #'lsp-deferred)
  (setq lsp-sqls-workspace-config-path nil)

  (setq lsp-sqls-connections
        '(((driver . "mysql") (dataSourceName . "mateus:local@tcp(localhost:3306)/foo"))
          ((driver . "postgresql") (dataSourceName . "host=127.0.0.1 port=5432 user=mateus password=local dbname=postgres sslmode=disable"))))
