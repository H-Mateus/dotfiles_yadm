...
You can force ivy to complete the input with =ivy-immediate-done= (default C-M-j)
...
Heavily inspired by [[https://jethrokuan.github.io/org-roam-guide/][this post]]
...
#+begin_src emacs-lisp
  ...
  ;; function to generate node from reference
  (defun efs/org-roam-node-from-cite (keys-entries)
  ...
  (efs/leader-keys
    ...
    "nc" '(efs/org-roam-node-from-cite :which-key "org-roam-cite")
    ...
    "nd" '(org-roam-dailies-map :which-key "daily map")
...
Taken from [[https://systemcrafters.net/build-a-second-brain-in-emacs/5-org-roam-hacks/][SystemCrafters]]
...
#+begin_src emacs-lisp
  ...
  ;; (global-set-key (kbd "SPC n p") #'my/org-roam-find-project)
  ...
  ;; (global-set-key (kbd "SPC n P") #'my/org-roam-capture-task)

  (efs/leader-keys
    "np" '(my/org-roam-find-project)
    "nP" '(my/org-roam-capture-task))
...
#+begin_src emacs-lisp
  ...
  (use-package markdown-mode
    ...
    (global-leader
      ...
      "h" '(:ignore h :which-key "headers")
      "hn" '(markdown-outline-next :which-key "next header")
      "hp" '(markdown-outline-previous :which-key "previous header")
      "hu" '(markdown-outline-up :which-key "parent header")
      "hk" '(markdown-move-up :which-key "move header up")
      "hj" '(markdown-move-down :which-key "move header down")
      "hh" '(markdown-promote :which-key "promote header")
      "hl" '(markdown-demote :which-key "demote header")
  ...
  ;; put #s before header but not after
